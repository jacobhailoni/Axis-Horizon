...
const MobileMenu: React.FC = () => {
  const [isSubActive, setSubIsActive] = useState<MenuState>({
    status: false,
    key: "",
  });
  const [isActive, setIsActive] = useState<MenuState>({
    status: false,
    key: "",
  });
  ...
  return (
    <ul className="navigation">
      ...
      {/* <li className="dropdown">
        ...
        <ul
          className={isActive.key === "pages" ? "sub-menu d-block" : "d-none"}
        >
          <li>
          ...
          <li>
            ...
            <ul className={isSubActive.key === "shop" ? "d-block" : "d-none"}>
              <li>
                <Link href="/shop-products">Shop Product</Link>
              </li>
              <li>
                <Link href="/shop-products-sidebar">Products Sidebar</Link>
              </li>
              <li>
          ...
          <li>
            <Link href="/page-404">404 Error</Link>
          </li>
        </ul>
        <div
      ...
      <li>
        ...
        >
          <li>
            <Link href="/page-services">Service Grid</Link>
          </li>
          <li>
      ...
      {/* <li className="dropdown">
        ...
        <ul
          className={
            isActive.key === "projects" ? "sub-menu d-block" : "d-none"
          }
        >
          <li>
            <Link href="/page-project">Projects</Link>
          </li>
          <li>
